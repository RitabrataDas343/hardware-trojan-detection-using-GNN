import yaml, os, sys, random as rnd
...
class Config:
    def __init__(self, args):
        ...
        ap.add_argument('--yaml_path', type=str, default="./config.yaml", help="The path of yaml config file.")
        ap.add_argument('--raw_dataset_path', type=str, default="../../dataset/TJ-RTL-toy/", help="The path to raw dataset for parsing.")
